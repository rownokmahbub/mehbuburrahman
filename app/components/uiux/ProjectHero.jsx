...
export default function ProjectHero() {
  ...
  return (
    <div
      ref={ref}
      className="relative main-light mt-mt-10 lg:mt-28 dark:main-dark px-4 lg:px-40"
      id="hero"
    >
      ...
      <div className=" flex flex-col justify-center  gap-10 items-center">
        ...
        >
         ...
         Here are some Of my projects that i have worked
          ...
          <div className="max-w-2xl w-full rounded-t-3xl overflow-hidden">
          <Image src='/main/uiuxservicedark.png' className="max-w-2xl w-full" width={1200} height={1200} alt="hero"/>
          </div>
