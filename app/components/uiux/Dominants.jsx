...
export default function Dominants() {
...
Get 20% discount on early purchase.
      ...
      {services.map((service,i)=>(
        ...
        animate={controls}
        variants={variants}
        transition={{ duration: 1 }} key={i} className="border-2 card-light dark:card-dark  relative border-slate-200  dark:border-[#282D45] px-4 py-3 md:px-5 md:py-5 flex flex-col justify-between md:justify-center items-center group rounded-xl">
    ...
    {service.icons}
            ...
            <h3 className='text-base lg:text-2xl my-2 md:my-4 font-semibold'>{service.title}</h3>
